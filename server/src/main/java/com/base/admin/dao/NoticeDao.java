...
public class NoticeDao {
    ...
    public int qryNoticeCount(String title) throws Exception {
    ...
    public List<Map<String, Object>> qryNoticeList(String title, int start, int size) throws Exception{
        Map<String, Object> params = new HashMap<>();
        params.put("start", start);
        params.put("size", size);
        String sql = " select id, (select name from t_n_column c where c.id=n.notice_type) as column_type_name, " +
                "   title, add_time from t_n_notice n where 1 = 1 ";
        if(title != null && !title.equals("")) {
            params.put("title", title);
            sql += " and title like " + "'%" + title + "%'";;
        }
    ...
    public boolean addNotice(String noticeType, String title, String content) throws Exception {
        Map<String, Object> params = new HashMap<>();
    ...
    public Map<String,Object> qryNoticeInfo(String id) throws  Exception{
        Map<String, Object> params = new HashMap<>();
    ...
    public boolean modifyNotice(String id, String noticeType, String title, String content) throws  Exception{
        Map<String, Object> params = new HashMap<>();
    ...
    public int delNotice(String id) throws Exception {
        Map<String, Object> params = new HashMap<>();
        String sql = " delete from  t_n_notice where id=:id";
        params.put("id", id);
